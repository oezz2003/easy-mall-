...
const productImages = [
  ...
  { src: 'https://placehold.co/601x601.png', alt: 'Product image 2', hint: 'product back' },
  { src: 'https://placehold.co/602x602.png', alt: 'Product image 3', hint: 'product side' },
  { src: 'https://placehold.co/603x603.png', alt: 'Product image 4', hint: 'product detail' },
];
